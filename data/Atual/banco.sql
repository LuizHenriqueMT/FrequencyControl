/*==============================================================*/
/* DBMS name:      MySQL 5.0                                    */
/* Created on:     17/11/2020 00:38:02                          */
/*==============================================================*/
...
(
   ...
   PERIODO_CONTROLE     char(1),
   AULAORDINAL_CONTROLE char(1),
...
alter table ALUNO_CONTROLE add constraint FK_REL_ALUNO_CONTROLEA foreign key (MATRICULA_ALUNO)
...
alter table CONTROLE_DE_FREQUENCIA add constraint FK_REL_ALUNO_CONTROLEF foreign key (MATRICULA_ALUNO)
      references ALUNO (MATRICULA_ALUNO) on delete restrict on update restrict;
